...
Environment:
  ...
  AUBE_CONFIG_FILE        Override the aube config file path.
  UV_CONFIG_FILE          Override the uv config file path.
  XDG_CONFIG_HOME         Override the XDG config root (affects mise, aube, uv on linux/mac).
"@
}
